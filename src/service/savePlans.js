...
export const savePlans = [
    {
    saveType: "Target Saving",
    image: require("../../assets/target.png"),
    description: "Hit the bullseye of financial goals with target saving -  plan,save,and achieve.",
...
},
{
    ...
    image: require("../../assets/money-bag.png"),
    description: "Balance wisely: Spend for today, save for tomorrow.",
    trust: "Welcome to a worry free financial planning. with PayVerve spend & save option, you are signing-up for financial growth. ",
    security: "With robust security measure in place. your information is safeguarded at every step.",
    financialGrowth: "Our commitment is to help you save seamlessly on each transaction, making every purchase a step towards financial growth.  Enjoy the convenience of your transaction while building a brighter financial future.",
    screen: "SpendAndSave"
}
]