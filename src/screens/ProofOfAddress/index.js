...
const ProofOfAddress = () => {
    ...
    return (<SafeAreaView style={styles.container}>
            ...
            <View style={{gap: 32}}>
                ...
                <Text style={styles.headerText}>Ensure your background is clear and your picture is of high
                    quality.</Text>
                ...
                <View style={styles.mediaWrapper}>
                    ...
                    <TouchableOpacity
                        ...
                        onPress={requestCameraAccess}
                    >
                        {capturedSelfie ? <Image source={{uri: capturedSelfie}} style={styles.capturedImage}/> :
                            <View style={styles.mediaInfoBox}>
